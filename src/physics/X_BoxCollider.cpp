...
static bool try_and_move_up_step(X_BoxCollider* collider, X_BspLevel* level, X_Vec3* oldPos, X_Vec3* oldVelocity, X_RayTracer* lastHitWallFromFirstAttempt)
{
...
{
    static X_Vec3 gravity = { 0, x_fp16x16_from_float(0.25), 0 };
