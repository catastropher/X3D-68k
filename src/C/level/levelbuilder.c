...
//     builder->selections[builder->current_selection].segment_selection = seg;
// }
// 
...
//     builder->selections[builder->current_selection].segment_selection = face_id;
// }
// 
...
//             x3d_levelbuilder_select_segmentface(builder->level, x3d_segfaceid_create(new_s));
//             
//     }
// }
// 
