...
////////////////////////////////////////////////////////////////////////////////
/// Sets every texel in a texture to the given color.
////////////////////////////////////////////////////////////////////////////////
static inline void x_texture_fill(X_Texture* tex, X_Color color)
{
    memset(tex->texels, color, x_texture_total_texels(tex));
}
